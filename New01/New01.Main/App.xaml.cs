...
using New01.Common;
using New01.Main.Properties;
using New01.Main.ViewModels;
using New01.Main.Views;
using New01.Modules.ViewModels;
using New01.Modules.Views;
using System.ComponentModel;
using System.Windows;
using AppModules = New01.Common.Modules;

namespace New01.Main
{
    ...
    public class Bootstrapper
    {
        ...
        protected virtual void RegisterModules()
        {
            ...
            Manager.Register(Regions.Navigation, new Module(AppModules.Module3, () => new NavigationItem("Module3")));
            ...
            Manager.Register(Regions.Documents, new Module(AppModules.Module3, () => ModuleViewModel.Create("Thanh Ngang Doc"), typeof(model3))); // hiện thị lên Documents
        ...
        protected virtual void InjectModules()
        {
            ...
            Manager.Inject(Regions.Navigation, AppModules.Module3);
